...
func TestHasTag(t *testing.T) {
	tags := []string{"hot", "cold", "restore-point"}
...
func TestSnapshotSortLogic(t *testing.T) {
	...
	snaps := []Snapshot{
		...
		{ShortID: "s3", Time: now, Tags: []string{"hot"}, Paths: []string{"/volumes/my-vol/data"}},
	}
