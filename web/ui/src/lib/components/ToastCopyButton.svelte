...
<div class="copy-wrapper">
  <button
    ...
    title="Copy text"
  >
    <svg role="img" aria-label="Copy text" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
